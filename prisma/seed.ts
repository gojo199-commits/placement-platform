...
async function main() {
    ...
    // Create Questions (5 per topic = 40 total)
    const questionsData = [
        // Logical Reasoning
        { topicId: topics[0].id, content: 'If all Bloops are Razzies and all Razzies are Lazzies, are all Bloops definitely Lazzies?', options: ['Yes', 'No', 'Cannot be determined', 'Only some'], correctAnswer: 'Yes', explanation: 'Classic syllogism: If A⊂B and B⊂C, then A⊂C.', difficulty: 'EASY' },
        ...
        { topicId: topics[0].id, content: 'If 5+3=28, 9+1=810, then 7+4=?', options: ['311', '411', '112', '211'], correctAnswer: '311', explanation: 'Pattern: difference then sum. 7-4=3, 7+4=11.', difficulty: 'HARD' },
        ...
        { topicId: topics[1].id, content: 'A does work in 12 days, B in 18. Together?', options: ['6.2', '7.2', '8.2', '9.2'], correctAnswer: '7.2', explanation: '1/12+1/18=5/36. Time=7.2 days.', difficulty: 'MEDIUM' },
        { topicId: topics[1].id, content: '40% markup, 20% discount. Profit?', options: ['8%', '10%', '12%', '15%'], correctAnswer: '12%', explanation: 'SP=140×0.8=112. Profit=12%.', difficulty: 'MEDIUM' },
        { topicId: topics[1].id, content: 'CI for 2 years at 10% is ₹420. Principal?', options: ['₹1800', '₹2000', '₹2200', '₹2500'], correctAnswer: '₹2000', explanation: '420=P×0.21. P=2000.', difficulty: 'HARD' },
        { topicId: topics[1].id, content: 'Milk:Water=4:1 in 45L. Water to add for 3:2?', options: ['12L', '15L', '18L', '20L'], correctAnswer: '15L', explanation: 'Milk=36. For 3:2, water=24. Add 15.', difficulty: 'HARD' },
        // Verbal
        ...
        { topicId: topics[2].id, content: '"Bury the hatchet" means:', options: ['Hide', 'Make peace', 'Dig', 'Give up'], correctAnswer: 'Make peace', explanation: 'End conflict.', difficulty: 'EASY' },
        ...
        { topicId: topics[2].id, content: 'Correct: "Neither of students..."', options: ['have their', 'has his', 'has their', 'have his'], correctAnswer: 'has his', explanation: 'Neither takes singular verb.', difficulty: 'MEDIUM' },
        ...
        { topicId: topics[3].id, content: 'Merge sort space?', options: ['O(1)', 'O(log n)', 'O(n)', 'O(n log n)'], correctAnswer: 'O(n)', explanation: 'Needs O(n) auxiliary.', difficulty: 'MEDIUM' },
        ...
        { topicId: topics[4].id, content: 'ACID stands for?', options: ['Atomicity,Consistency,Isolation,Durability', 'Addition,Calc,Insert,Delete', 'Atom,Calc,Iso,Dur', 'Add,Cons,Ins,Dur'], correctAnswer: 'Atomicity,Consistency,Isolation,Durability', explanation: 'Transaction properties.', difficulty: 'EASY' },
        ...
        // OS
        { topicId: topics[5].id, content: 'What is deadlock?', options: ['Waiting for CPU', 'Processes waiting each other', 'Crash', 'Memory error'], correctAnswer: 'Processes waiting each other', explanation: 'Circular wait.', difficulty: 'EASY' },
        { topicId: topics[5].id, content: 'Virtual memory purpose?', options: ['Speed CPU', 'Run larger programs', 'Backup', 'Encrypt'], correctAnswer: 'Run larger programs', explanation: 'Uses disk as RAM extension.', difficulty: 'EASY' },
    ...
    for (const student of students) {
        ...
        const shuffled = [...questions].sort(() => Math.random() - 0.5).slice(0, numAttempts)
